...
async function launchBrowser (options = {}, indexPath = 0) {
  const executablePath =
    options.executablePath || BROWSER_PATHS[build.os][indexPath]
  ...
  args.push('--download-prompts-disabled')
  args.push('--download-directory=/Volumes/T0/sftmpdl2')
  const command = new Command(executablePath, {
    args,
    stdout: PIPED_STD_CONFIG,
    stderr: PIPED_STD_CONFIG
  })
  try {
