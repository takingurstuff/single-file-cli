...
const OPTIONS_INFO = {
  'accept-header-font': {
    description: 'Accept header for fonts',
    type: 'string',
    defaultValue:
      'application/font-woff2;q=1.0,application/font-woff;q=0.9,*/*;q=0.8'
  },
  'accept-header-image': {
    description: 'Accept header for images',
    type: 'string',
    defaultValue:
      'image/avif,image/webp,image/apng,image/svg+xml,image/*,*/*;q=0.8'
  },
  'accept-header-stylesheet': {
    description: 'Accept header for stylesheets',
    type: 'string',
    defaultValue: 'text/css,*/*;q=0.1'
  },
  'accept-header-script': {
    description: 'Accept header for scripts',
    type: 'string',
    defaultValue: '*/*'
  },
  'accept-header-document': {
    description: 'Accept header for documents',
    type: 'string',
    defaultValue:
      'text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8'
  },
  'block-audios': {
    description: 'Block audios',
    type: 'boolean',
    defaultValue: true
  },
  ...
  'block-videos': {
    description: 'Block videos',
    type: 'boolean',
    defaultValue: true
  },
  'block-mixed-content': {
    description: 'Block mixed contents',
    type: 'boolean'
  },
  ...
  'browser-load-max-time': {
    description: 'Maximum delay of time to wait for page loading in ms',
    type: 'number',
    defaultValue: 60000
  },
  'browser-wait-delay': {
  ...
  'browser-wait-until': {
    description:
      'When to consider the page is loaded (InteractiveTime, networkIdle, networkAlmostIdle, load, domContentLoaded)',
    type: 'string',
  ...
  'browser-arg': {
    description: 'Argument passed to the browser',
    type: 'string[]',
    alias: 'browser-argument'
  },
  'browser-args': {
    description: 'Arguments provided as a JSON array and passed to the browser',
    type: 'string'
  },
  ...
  'browser-cookie': {
    description:
      'Ordered list of cookie parameters separated by a comma (name,value,domain,path,expires,httpOnly,secure,sameSite,url)',
    type: 'string[]'
  },
  ...
  'browser-remote-debugging-URL': {
    description: 'Remote debugging URL',
    type: 'string'
  },
  ...
  'browser-device-width': {
    description:
      'Width of the device viewport in pixels (default value is 360 when using --browser-mobile-emulation)',
    type: 'number'
  },
  'browser-device-height': {
    description:
      'Height of the device viewport in pixels (default value is 800 when using --browser-mobile-emulation)',
    type: 'number'
  },
  'browser-device-scale-factor': {
    description:
      'Scale factor of the device viewport (default value is 2 when using --browser-mobile-emulation)',
    type: 'number'
  },
  'compress-CSS': { description: 'Compress CSS stylesheets', type: 'boolean' },
  'compress-HTML': {
    description: 'Compress HTML content',
    type: 'boolean',
    defaultValue: true
  },
  'crawl-links': {
  ...
  'crawl-external-links-max-depth': {
    description:
  ...
  'emulate-media-feature': {
    description:
      'Emulate a media feature. The syntax is <name>:<value>, e.g. "prefers-color-scheme:dark"',
    type: 'string[]'
  },
  'error-file': {
    description: 'Path of the file where to save the error messages',
    type: 'string'
  },
  'filename-template': {
    description:
  ...
  'filename-max-length': {
    description: 'Specify the maximum length of the filename',
    type: 'number',
    defaultValue: 192
  },
  'filename-max-length-unit': {
    description:
      "Specify the unit of the maximum length of the filename ('bytes' or 'chars')",
    type: 'string',
    defaultValue: 'bytes'
  },
  'replace-emojis-in-filename': {
    description:
      'Replace emojis in the filename with their unicode text representation',
    type: 'boolean'
  },
  ...
  'insert-meta-CSP': {
    description:
      'Include a <meta> tag with a CSP to avoid potential requests to internet when viewing a page',
    type: 'boolean',
    defaultValue: true
  },
  'load-deferred-images': {
    description: 'Load deferred (a.k.a. lazy-loaded) images',
    type: 'boolean',
    defaultValue: true
  },
  'load-deferred-images-dispatch-scroll-event': {
    description: "Dispatch 'scroll' event when loading deferred images",
    type: 'boolean'
  },
  'load-deferred-images-max-idle-time': {
    description: 'Maximum delay of time to wait for deferred images in ms',
    type: 'number',
    defaultValue: 1500
  },
  'load-deferred-images-keep-zoom-level': {
    description: 'Load deferred images by keeping zoomed out the page',
    type: 'boolean'
  },
  'load-deferred-images-before-frames': {
    description: 'Load deferred frames before before saving fame contents',
    type: 'boolean'
  },
  ...
  password: {
    description:
      'Password of the zip file when using --compress-content or --self-extracting-archive',
    type: 'string'
  },
  ...
  'remove-saved-date': {
    description: 'Remove saved date metadata in HTML header',
    type: 'boolean'
  },
  ...
  platform: {
    description:
      'Platform of the browser (default value is "Android" when using --browser-mobile-emulation)',
    type: 'string'
  },
  'user-script-enabled': {
    description:
  ...
  'compress-content': {
    description: 'Create a ZIP file instead of an HTML file',
    type: 'boolean'
  },
  'self-extracting-archive': {
    description: 'Create a self-extracting (ZIP) HTML file',
    type: 'boolean',
    defaultValue: true
  },
  'insert-text-body': {
    description:
      'Insert the text of the page into the self-extracting HTML file',
    type: 'boolean'
  },
  'create-root-directory': {
    description: 'Create a root directory based on the timestamp',
    type: 'boolean'
  },
  'extract-data-from-page': {
    description:
      'Extract compressed data from the page instead of fetching the page in order to create universal self-extracting HTML files',
    type: 'boolean',
    defaultValue: true
  },
  'prevent-appended-data': {
    description:
      'Prevent appending data after the compressed data when creating self-extracting HTML files',
    type: 'boolean'
  },
  'embed-screenshot': {
    description:
      'Embed a screenshot of the page as a PNG file in the compressed file (self-extracting HTML or ZIP file). When enabled, the resulting file can be read as a ZIP file or a PNG image.',
    type: 'boolean'
  },
  'output-directory': {
...
async function getOptions () {
  ...
  if (
    (!positionals.length && !Object.keys(options).length) ||
    ...
    Object.keys(OPTIONS_INFO).forEach(optionName => {
      ...
      const optionDefaultValue =
        optionInfo.defaultValue === undefined
          ? ''
          : `(default: ${JSON.stringify(optionInfo.defaultValue)})`
      console.log(
        `  --${optionName}: ${optionDescription} <${optionType}> ${optionDefaultValue}`
      ) // eslint-disable-line no-console
    })
  ...
  while (argIndex < args.length) {
    ...
    if (optionInfo) {
      ...
      if (argValue === undefined) {
        ...
        isValid(optionInfo.type, argValue) &&
        (isArray(optionInfo.type) || !options[argName].length)
      ) {
...
function getOptionInfo (optionName) {
  return OPTIONS_INFO[
    Object.keys(OPTIONS_INFO).find(
      keyName => keyName.toLowerCase() == optionName.toLowerCase()
    )
  ]
}
